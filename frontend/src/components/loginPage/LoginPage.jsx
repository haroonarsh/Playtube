...
<div class="min-h-screen bg-[#121212]">
  ...
  <div class="mx-auto flex w-full items-stretch justify-between gap-10">
    <div class="mt-20 flex w-full flex-col items-start justify-start p-6 md:w-1/2 lg:px-10">
      <div class="w-full">
        <h1 class="mb-2 text-5xl font-extrabold text-white">Log in</h1>
        <p class="text-xs text-slate-400">Before we start, please log into your account</p>
      </div>
      <div class="my-14 flex w-full flex-col items-start justify-start gap-4">
        ...
        <div class="inline-flex w-full items-center justify-between">
          ...
          <p class="cursor-pointer text-sm text-white hover:underline">Forgot password?</p>
        </div>
        <button
        ...
        <div class="mx-auto my-3 flex w-full max-w-md items-center justify-center gap-4 text-white">
          <hr class="w-full border-[0.1px] border-white" />
          <p class="text-sm">OR</p>
          <hr class="w-full border-[0.1px] border-white" />
        </div>
        <button class="inline-flex w-full items-center justify-center gap-3 border-[1px] border-white bg-black p-3 text-center text-white">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24"
            viewBox="0 0 24 24"
        ...
        <p class="my-14 text-sm font-light text-white">
          ...
          <span class="cursor-pointer font-bold hover:underline">Create an account</span>
        </p>
      </div>
    </div>
