          ...
          <div className="border">
            <div className="w-full max-w-3xl gap-x-4 sm:flex">
              ...
              <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                ...
                <div className="w-full">
                  <h6 className="mb-1 font-semibold sm:max-w-[75%]">JavaScript Fundamentals: Variables and Data Types</h6>
          ...
          <div className="border">
            <div className="w-full max-w-3xl gap-x-4 sm:flex">
              ...
              <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                ...
                <div className="w-full">
                  <h6 className="mb-1 font-semibold sm:max-w-[75%]">Building a RESTful API with Node.js and Express</h6>
          ...
          <div className="border">
            <div className="w-full max-w-3xl gap-x-4 sm:flex">
              ...
              <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                ...
                <div className="w-full">
                  <h6 className="mb-1 font-semibold sm:max-w-[75%]">Building Scalable Web Applications with Django</h6>
          ...
          <div className="border">
            <div className="w-full max-w-3xl gap-x-4 sm:flex">
              ...
              <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                ...
                <div className="w-full">
                  <h6 className="mb-1 font-semibold sm:max-w-[75%]">Node.js Authentication with Passport.js</h6>
          ...
          <div className="border">
            <div className="w-full max-w-3xl gap-x-4 sm:flex">
              ...
              <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                ...
                <div className="w-full">
                  <h6 className="mb-1 font-semibold sm:max-w-[75%]">Building Real-Time Applications with Socket.IO</h6>
          ...
          <div className="border">
            <div className="w-full max-w-3xl gap-x-4 sm:flex">
              ...
              <div className="flex gap-x-2 px-2 sm:w-7/12 sm:px-0">
                ...
                <div className="w-full">
                  <h6 className="mb-1 font-semibold sm:max-w-[75%]">Advanced CSS: Animations and Transitions</h6>
