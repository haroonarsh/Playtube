    ...
    <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
      ...
      <div className="px-4 pb-4">
        ...
        <ul className="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-[#121212] py-2 sm:top-[82px]">
          ...
          <li className="w-full"><button className="w-full border-b-2 border-[#ae7aff] bg-white px-3 py-1.5 text-[#ae7aff]">Playlist</button></li>
        ...
        <div className="grid gap-4 pt-2 sm:grid-cols-[repeat(auto-fit,_minmax(400px,_1fr))]">
          ...
          <div className="w-full">
            ...
            <p className="flex text-sm text-gray-200">Learn the core concepts and fundamentals of JavaScript programming language.</p>
          </div>
          <div className="w-full">
            <div className="relative mb-2 w-full pt-[56%]">
              <div className="absolute inset-0">
            ...
            <p className="flex text-sm text-gray-200">Dive into TypeScript for enhanced type safety and scalable JavaScript applications.</p>
          </div>
          <div className="w-full">
            <div className="relative mb-2 w-full pt-[56%]">
              <div className="absolute inset-0">
            ...
            <p className="flex text-sm text-gray-200">Explore various state management techniques in React applications.</p>
          </div>
          <div className="w-full">
            <div className="relative mb-2 w-full pt-[56%]">
              <div className="absolute inset-0">
            ...
            <p className="flex text-sm text-gray-200">Delve into advanced JavaScript concepts and techniques for professional-level programming.</p>
          </div>
        </div>
      </div>
    </section>
