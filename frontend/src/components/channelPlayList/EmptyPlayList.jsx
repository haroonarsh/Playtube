      ...
      <ul className="flex justify-around gap-y-2 sm:sticky sm:top-[106px] sm:min-h-[calc(100vh-130px)] sm:flex-col">
        <li className="">
          <button
            ...
            <Link to='/home' className="block sm:hidden sm:group-hover:inline lg:inline">Home</Link>
          </button>
        </li>
    ...
    <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
      ...
      <div className="px-4 pb-4">
        ...
        <ul className="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-[#121212] py-2 sm:top-[82px]">
          ...
          <Link to='/home/channel/tweet/:id' className="w-full"><button className="w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400">Tweets</button></Link>
