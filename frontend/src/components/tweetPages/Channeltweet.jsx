...
<header className="sticky inset-x-0 top-0 z-50 w-full border-b border-white bg-[#121212] px-4">
    <nav className="mx-auto flex max-w-7xl items-center py-2">
      <Link to="/home" className="mr-4 w-12 shrink-0 sm:w-16">
        <svg
          style={{width: "100%"}}
          viewBox="0 0 63 64"
          fill="none"
    ...
    <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
      ...
      <div className="px-4 pb-4">
        ...
        <ul className="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-[#121212] py-2 sm:top-[82px]">
          <Link to='/home/channel' className="w-full"><button className="w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400">Videos</button></Link>
          <Link to='/home/channel/playlist' className="w-full"><button className="w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400">Playlist</button></Link>
          <li className="w-full"><button className="w-full border-b-2 border-[#ae7aff] bg-white px-3 py-1.5 text-[#ae7aff]">Tweets</button></li>
          <Link to='/home/channel/subscribed' className="w-full"><button className="w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400">Subscribed</button></Link>
        </ul>
        <div className="py-4">
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Exploring the latest features in JavaScript ES11! The language keeps evolving. 💡 #JavaScript #ES11</p>
          ...
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Embracing the benefits of TypeScript for stronger, more reliable code. 🚀 #TypeScript #Programming</p>
              <div className="flex gap-4">
                <button
                  className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)]"
                  data-like-count="425"
          ...
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Styling made easy with Tailwind CSS! Rapidly build beautiful, responsive interfaces. 🎨 #TailwindCSS #WebDev</p>
              <div className="flex gap-4">
                <button
                  className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)]"
                  data-like-count="425"
          ...
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Building dynamic user interfaces with React! The go-to library for modern web development. 🚀 #React #WebDev</p>
              <div className="flex gap-4">
                <button
                  className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)]"
                  data-like-count="425"
          ...
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Next.js makes server-side rendering a breeze! Boost your React app&#x27;s performance with ease. 🚀 #Nextjs #React</p>
              <div className="flex gap-4">
                <button
                  className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)]"
                  data-like-count="425"
          ...
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Dive into advanced JavaScript concepts like closures and prototypes. Level up your coding skills! 🔍 #AdvancedJS #CodingTips</p>
              <div className="flex gap-4">
                <button
                  className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)]"
                  data-like-count="425"
          ...
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Mastering TypeScript: From basics to advanced concepts. Boost your development workflow with strong typing! 🚀 #TypeScript #Development</p>
              <div className="flex gap-4">
                <button
                  className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)]"
                  data-like-count="425"
          ...
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Simplify your CSS workflow with Tailwind CSS. Effortless styling for modern web development! 🎨 #TailwindCSS #WebDev</p>
              <div className="flex gap-4">
                <button
                  className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)]"
                  data-like-count="425"
          ...
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Building dynamic UIs with React - A comprehensive guide for developers. Get started with React today! 🚀 #React #WebDevelopment</p>
              <div className="flex gap-4">
                <button
                  className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)]"
                  data-like-count="425"
          ...
          <div className="flex gap-3 border-b border-gray-700 py-4 last:border-b-transparent">
            ...
            <div className="w-full">
              ...
              <p className="mb-2">Optimize server-side rendering with Next.js. Improve performance and SEO for your React applications! 🚀 #Nextjs #React</p>
              <div className="flex gap-4">
                <button
                  className="group inline-flex items-center gap-x-1 outline-none after:content-[attr(data-like-count)] focus:after:content-[attr(data-like-count-alt)]"
                  data-like-count="425"
