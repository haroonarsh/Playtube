    ...
    <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
      ...
      <div className="px-4 pb-4">
        ...
        <ul className="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-[#121212] py-2 sm:top-[82px]">
          ...
          <li className="w-full"><button className="w-full border-b-2 border-[#ae7aff] bg-white px-3 py-1.5 text-[#ae7aff]">Change Password</button></li>
        </ul>
          ...
          <div className="w-full sm:w-1/2 lg:w-2/3">
            <div className="rounded-lg border">
              ...
              <div className="flex items-center justify-end gap-4 p-4">
                ...
                <button className="inline-block bg-[#ae7aff] px-3 py-1.5 text-black">Update Password</button>
              </div>
            </div>
          </div>
        </div>
