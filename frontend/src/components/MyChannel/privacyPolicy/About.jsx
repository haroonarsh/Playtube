...
function About() {
  ...
  <section className="relative mx-auto max-w-3xl px-4 py-20">
    <div className="mb-16 text-center">
      ...
      <h3 className="text-gray-300">Your privacy is important to us at videoTube. We repect your privacy regarding any information we may collect from you across out website.</h3>
    </div>
    <div className="mb-8">
