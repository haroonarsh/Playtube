      ...
      <ul className="flex justify-around gap-y-2 sm:sticky sm:top-[106px] sm:min-h-[calc(100vh-130px)] sm:flex-col">
        ...
        <li className="hidden sm:block">
          <button
            ...
            <Link className="block sm:hidden sm:group-hover:inline lg:inline">Liked Videos</Link>
          </button>
        </li>
        <li className="">
          <button
    ...
    <section className="w-full pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0">
      ...
      <div className="px-4 pb-4">
        ...
        <ul className="no-scrollbar sticky top-[66px] z-[2] flex flex-row gap-x-2 overflow-auto border-b-2 border-gray-400 bg-[#121212] py-2 sm:top-[82px]">
          ...
          <Link to='/home/channel/tweet' className="w-full"><button className="w-full border-b-2 border-transparent px-3 py-1.5 text-gray-400">Tweets</button></Link>
        ...
        <div className="flex justify-center p-4">
          <div className="w-full max-w-sm text-center">
            ...
            <Link to='/home/channel/upload' className="mt-4 inline-flex items-center gap-x-2 bg-[#ae7aff] px-3 py-2 font-semibold text-black">
             <span className='text-2xl'>+</span> New video
            </Link>
          </div>
        </div>
      </div>
