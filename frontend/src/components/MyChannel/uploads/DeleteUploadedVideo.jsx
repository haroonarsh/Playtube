...
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center"><span class="inline-block rounded-2xl border px-1.5 py-0.5 border-green-600 text-green-600">Published</span></div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
...
//                     alt="Code Master" />
//                   <h3 class="font-semibold">JavaScript Fundamentals: Variables and Data Types</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">921 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">49 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">22/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
...
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center"><span class="inline-block rounded-2xl border px-1.5 py-0.5 border-orange-600 text-orange-600">Unpublished</span></div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex items-center gap-4">
//                   <img
...
//                     alt="React Ninja" />
//                   <h3 class="font-semibold">React Hooks Explained: useState and useEffect</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">2520 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">279 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">21/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="Async Masters" />
//                   <h3 class="font-semibold">Mastering Async Await in JavaScript</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">943 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">244 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">20/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="Code Crafters" />
//                   <h3 class="font-semibold">Building a ToDo App with React and Context API</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">760 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">302 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">19/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="Tailwind Pro" />
//                   <h3 class="font-semibold">Responsive Web Design with Tailwind CSS</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">2630 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">317 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">18/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">137 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">107 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">17/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">1250 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">386 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">16/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="API Builder" />
//                   <h3 class="font-semibold">Building a RESTful API with Node.js and Express</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">2773 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">50 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">15/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">1346 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">353 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">14/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">1578 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">294 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">13/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="CSS Wizard" />
//                   <h3 class="font-semibold">Advanced CSS: Flexbox and Grid Layouts</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">2506 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">87 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">12/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="Pythonista" />
//                   <h3 class="font-semibold">Introduction to Python Programming</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">1312 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">399 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">11/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="Django Master" />
//                   <h3 class="font-semibold">Building Scalable Web Applications with Django</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">553 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">219 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">10/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="ML Geek" />
//                   <h3 class="font-semibold">Deep Dive into Machine Learning Algorithms</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">2061 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">359 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">09/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="ReactD3" />
//                   <h3 class="font-semibold">Creating Interactive UIs with React and D3</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">1165 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">10 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">08/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="Passport Pro" />
//                   <h3 class="font-semibold">Node.js Authentication with Passport.js</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">1812 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">347 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">07/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="Django Rest API" />
//                   <h3 class="font-semibold">Creating RESTful APIs with Django Rest Framework</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">1698 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">159 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">06/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="JS Ninja" />
//                   <h3 class="font-semibold">Advanced JavaScript: Closures and Prototypes</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">2393 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">146 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">05/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">2137 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">280 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">04/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                   <h3 class="font-semibold">Building Real-Time Applications with Socket.IO</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">2991 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">155 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">03/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     src="https://images.pexels.com/photos/18264716/pexels-photo-18264716/free-photo-of-man-people-laptop-internet.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
//                     alt="GraphQL Pro" />
//                   <h3 class="font-semibold">GraphQL: Building APIs with Query Language</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">1095 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">359 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">02/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     alt="MERN Stack" />
//                   <h3 class="font-semibold">Full-Stack Development with MERN</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">2375 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">152 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">01/09/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     src="https://images.pexels.com/photos/18264716/pexels-photo-18264716/free-photo-of-man-people-laptop-internet.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
//                     alt="CSS Animations" />
//                   <h3 class="font-semibold">Advanced CSS: Animations and Transitions</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">904 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">324 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">31/08/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//                     src="https://images.pexels.com/photos/18264716/pexels-photo-18264716/free-photo-of-man-people-laptop-internet.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
//                     alt="ML Image" />
//                   <h3 class="font-semibold">Machine Learning for Image Recognition</h3>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">912 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">97 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">30/08/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex justify-center gap-4">
//                   <span class="inline-block rounded-xl bg-green-200 px-1.5 py-0.5 text-green-700">1391 likes</span>
//                   <span class="inline-block rounded-xl bg-red-200 px-1.5 py-0.5 text-red-700">319 dislikes</span>
//                 </div>
//               </td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">29/08/2023</td>
//               <td class="border-collapse border-b border-gray-600 px-4 py-3 group-last:border-none">
//                 <div class="flex gap-4">
//                   <button class="h-5 w-5 hover:text-[#ae7aff]">
//                     <svg
...
//             Delete Video
//             <span class="block text-sm text-gray-300">Are you sure you want to delete this video? Once its deleted, you will not be able to recover it.</span>
//           </h2>
//           <button class="ml-auto h-6 w-6 shrink-0">
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
//               fill="none"
//               viewBox="0 0 24 24"
...
//           <button class="col-span-2 border px-4 py-3 sm:col-span-1">Cancel</button>
//           <button class="col-span-2 bg-red-700 px-4 py-3 disabled:bg-[#E4D3FF] sm:col-span-1">Delete</button>
//         </div>
//       </div>
//     </div>
//   </div>
...
// export default DeleteUploadedVideo
      ...
      <div className="mx-auto w-full max-w-lg overflow-auto rounded-lg border border-gray-700 bg-[#121212] p-4">
        <div className="mb-6 flex items-start gap-4">
          ...
          <h2 className="text-xl font-semibold">
            Delete Video
            <span className="block text-sm text-gray-300">Are you sure you want to delete this video? Once its deleted, you will not be able to recover it.</span>
          </h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <button className="col-span-2 bg-red-700 px-4 py-3 disabled:bg-[#E4D3FF] sm:col-span-1">Delete</button>
        </div>
      </div>
    </div>
        </>
