      ...
      <ul className="flex justify-around gap-y-2 sm:sticky sm:top-[106px] sm:min-h-[calc(100vh-130px)] sm:flex-col">
        ...
        <li className="hidden sm:block">
          <button
            ...
            <span className="block sm:hidden sm:group-hover:inline">My Content</span>
          </button>
        </li>
        <li className="">
          <button
            ...
            <div>
              <div className="flex gap-x-4">
                ...
                <div className="block">
                  ...
                  <p className="mt-3 text-sm">This series is exactly what I&#x27;ve been looking htmlFor! Excited to dive into these advanced React patterns. Thanks htmlFor putting this together!</p>
                </div>
              </div>
              <hr className="my-4 border-white" />
            </div>
            <div>
              <div className="flex gap-x-4">
                ...
                <div className="block">
                  ...
                  <p className="mt-3 text-sm">Render props have always been a bit tricky htmlFor me. Can&#x27;t wait to see how this series breaks it down. Thanks htmlFor sharing!</p>
                </div>
              </div>
              <hr className="my-4 border-white" />
            </div>
            <div>
              <div className="flex gap-x-4">
                ...
                <div className="block">
                  ...
                  <p className="mt-3 text-sm">Higher-order components have been a mystery to me htmlFor far too long. Looking forward to demystifying them with this series. Thanks!</p>
                </div>
              </div>
              <hr className="my-4 border-white" />
            </div>
            <div>
              <div className="flex gap-x-4">
                ...
                <div className="block">
                  ...
                  <p className="mt-3 text-sm">Compound components are a game-changer htmlFor UI development. Can&#x27;t wait to learn more about them. Great work on this series!</p>
                </div>
              </div>
              <hr className="my-4 border-white" />
            </div>
            <div>
              <div className="flex gap-x-4">
                ...
                <div className="block">
                  ...
                  <p className="mt-3 text-sm">Controlled vs. uncontrolled components - finally! This topic has always confused me. Thanks htmlFor breaking it down!</p>
                </div>
              </div>
              <hr className="my-4 border-white" />
            </div>
            <div>
              <div className="flex gap-x-4">
                ...
                <div className="block">
                  ...
                  <p className="mt-3 text-sm">This series is a goldmine htmlFor React developers! Compound components are something I&#x27;ve been eager to master. Thanks htmlFor this!</p>
                </div>
              </div>
              <hr className="my-4 border-white" />
            </div>
            <div>
              <div className="flex gap-x-4">
                ...
                <div className="block">
                  ...
                  <p className="mt-3 text-sm">This is exactly what I needed to take my React skills to the next level. Looking forward to diving into the render props section!</p>
                </div>
              </div>
              <hr className="my-4 border-white" />
            </div>
            <div>
              <div className="flex gap-x-4">
                ...
                <div className="block">
                  ...
                  <p className="mt-3 text-sm">This series looks amazing! I&#x27;m especially excited to learn more about controlled vs. uncontrolled components. Thanks htmlFor sharing!</p>
                </div>
              </div>
              <hr className="my-4 border-white" />
            </div>
        ...
        <div className="col-span-12 flex w-full shrink-0 flex-col gap-3 lg:w-[350px] xl:w-[400px]">
          ...
          <div className="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div className="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div className="w-full pt-1 md:pt-0">
                <h6 className="mb-1 text-sm font-semibold">Building a RESTful API with Node.js and Express</h6>
          ...
          <div className="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div className="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div className="w-full pt-1 md:pt-0">
                <h6 className="mb-1 text-sm font-semibold">Building Scalable Web Applications with Django</h6>
          ...
          <div className="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div className="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div className="w-full pt-1 md:pt-0">
                <h6 className="mb-1 text-sm font-semibold">Creating Interactive UIs with React and D3</h6>
          ...
          <div className="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div className="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div className="w-full pt-1 md:pt-0">
                <h6 className="mb-1 text-sm font-semibold">Node.js Authentication with Passport.js</h6>
          ...
          <div className="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div className="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div className="w-full pt-1 md:pt-0">
                <h6 className="mb-1 text-sm font-semibold">Building Real-Time Applications with Socket.IO</h6>
          ...
          <div className="w-full gap-x-2 border pr-2 md:flex">
            ...
            <div className="flex gap-x-2 px-2 pb-4 pt-1 md:w-7/12 md:px-0 md:py-0.5">
              ...
              <div className="w-full pt-1 md:pt-0">
                <h6 className="mb-1 text-sm font-semibold">Advanced CSS: Animations and Transitions</h6>
